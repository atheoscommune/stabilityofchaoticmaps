...
<title>Complex Logistic map fractal</title>
</head>
<body>
	...
	<div style="margin-left: 15%" class="w3-row">
			...
			<form action="WebReqHandler" id="form" class="w3-border">
				...
				<div class="w3-padding-large">
					...
					<input class="w3-input w3-border" type="hidden" name="reqType"
						value="complogfrac" /> <span>rx</span><input
						class="w3-input w3-border" type="text" name="rx"
						placeholder="The real component of param r"
						required /><span>ry</span><input class="w3-input w3-border"
						type="text" name="ry"
						placeholder="The imaginary component of param r"
						required /><span>n</span> <input class="w3-input w3-border"
						type="text" name="n"
						...
						placeholder="Name of the image to be generated" required /> <span>B</span><input
						class="w3-input w3-border" type="text" name="B"
		...
		<div class="w3-col m6 w3-padding">
			...
			<p class="w3-pale-green">Complex Logistic fractals are plotted
